...
function App() {
  ...
  // skeleton loading screen: shown for a minimum time, then fades out
  ...
  const skeletonLeaving = themeLoaded && minElapsed;
  useEffect(() => {
  ...
  return (
    <>
      <h1 className="sr-only" aria-label="icarus77">icarus77</h1>
      {!skeletonGone && <SkeletonScreen leaving={skeletonLeaving} />}
      {themeLoaded && (
