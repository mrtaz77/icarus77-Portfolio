...
const DesktopShortcuts: React.FC<Props> = ({ onOpenTerminal, onOpenWelcome, onOpenResume, hidden, activeTerminal, activeBrowser, activeResume, mobileExpanded }) => {
  return (
    <Grid hidden={hidden} mobileExpanded={mobileExpanded}>
      ...
      <DesktopShortcut label="LinkedIn" href="https://www.linkedin.com/in/mostafa-rifat-tazwar/" icon={Icons.LinkedIn} />
      <DesktopShortcut label="GitHub" href="https://github.com/mrtaz77" icon={Icons.GitHub} />
      <DesktopShortcut label="Kaggle" href="https://www.kaggle.com/icarus77" icon={Icons.Blog} />
