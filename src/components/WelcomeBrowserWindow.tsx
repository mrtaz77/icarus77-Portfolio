...
const WelcomeBrowserWindow: React.FC<Props> = ({ onClose, onMinimize, isMaximized=false, onToggleMaximize, x=140, y=60, width=900, height=560, onMove, onResize, visible=true, onFocus, zIndex }) => {
  ...
  return (
    <Frame x={x} y={y} width={width} height={height} maximized={isMaximized} hidden={!visible} isTransforming={!dragging.current && !resizing.current} zIndex={zIndex}>
      ...
      <Toolbar>
        <LocationBar>https://icarus77.netlify.app</LocationBar>
      </Toolbar>
        ...
        <div style={{
          ...
          <section style={{
            ...
            <div>
              ...
              <p style={{
                ...
                color: '#D8DEE9',
                opacity: 0.95
              }}>Mostafa Rifat Tazwar • CSE @ BUET • Federated Learning • 5G Formal Verification • Cybersecurity</p>
              <div role="group" aria-label="Quick links" style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '12px' }}>
                <a href="https://github.com/mrtaz77" target="_blank" rel="noreferrer" style={{
                  textDecoration: 'none',
                  color: '#88C0D0',
                ...
                <a href="https://www.linkedin.com/in/mostafa-rifat-tazwar/" target="_blank" rel="noreferrer" style={{
                ...
                <a href="https://tryhackme.com/p/icarus77" target="_blank" rel="noreferrer" style={{
                ...
                <a href="https://www.kaggle.com/icarus77" target="_blank" rel="noreferrer" style={{
          ...
          <div style={{
            ...
            <div
              ...
              onClick={() => window.open('https://tryhackme.com/p/icarus77', '_blank')}
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', gap: '10px' }}>
                ...
                <h3 style={{ margin: 0, color: '#88C0D0', fontSize: '1.05rem' }}>CTF</h3>
              </div>
              <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.6, color: '#D8DEE9' }}>
                <li>Champion, <strong style={{ color: '#FFD700' }}>Cyber Raid CTF 2025</strong></li>
                <li>1st Runner Up, <strong style={{ color: '#E6EAF0' }}>iCTF 2024</strong></li>
                <li>1st Runner Up, <strong style={{ color: '#E6EAF0' }}>Inter University BUET CTF 2024</strong></li>
                <li>1st Runner Up, <strong style={{ color: '#E6EAF0' }}>National Robofest CTF 2024</strong></li>
              </ul>
            </div>

            <div
              style={{
                background: 'linear-gradient(135deg, rgba(180, 142, 173, 0.10) 0%, rgba(94, 129, 172, 0.10) 100%)',
                border: '1px solid rgba(180, 142, 173, 0.25)',
                borderRadius: '14px',
                padding: '18px',
                transition: 'transform 0.2s ease, box-shadow 0.2s ease'
              }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 14px 30px rgba(180, 142, 173, 0.18)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', gap: '10px' }}>
                <span style={{ fontSize: '1.5rem' }}>🏆</span>
                <h3 style={{ margin: 0, color: '#B48EAD', fontSize: '1.05rem' }}>Hackathon</h3>
              </div>
              <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.6, color: '#D8DEE9' }}>
                <li>1st Runner Up, <strong style={{ color: '#7DB2FF' }}>Learnathon 3.0</strong> (MERN Stack Track), 2025</li>
              </ul>
            </div>

            <div
              style={{
                background: 'linear-gradient(135deg, rgba(129, 161, 193, 0.10) 0%, rgba(136, 192, 208, 0.10) 100%)',
                border: '1px solid rgba(129, 161, 193, 0.25)',
                borderRadius: '14px',
                padding: '18px',
                transition: 'transform 0.2s ease, box-shadow 0.2s ease'
              }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-3px)'; e.currentTarget.style.boxShadow = '0 14px 30px rgba(129, 161, 193, 0.18)'; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', gap: '10px' }}>
                <span style={{ fontSize: '1.5rem' }}>🔬</span>
                <h3 style={{ margin: 0, color: '#81A1C1', fontSize: '1.05rem' }}>Research</h3>
              </div>
              <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.6, color: '#D8DEE9' }}>
                <li>Co-authored <a href="https://aclanthology.org/2025.findings-acl.1360/" target="_blank" rel="noreferrer" style={{ color: '#81A1C1', fontWeight: 700, textDecoration: 'underline' }}>CSTRL</a> (ACL Findings 2025)</li>
              </ul>
            </div>

            <div
              style={{
                background: 'linear-gradient(135deg, rgba(208, 135, 112, 0.10) 0%, rgba(191, 97, 106, 0.10) 100%)',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', gap: '10px' }}>
                <span style={{ fontSize: '1.5rem' }}>🎓</span>
                <h3 style={{ margin: 0, color: '#D08770', fontSize: '1.05rem' }}>Academia</h3>
              </div>
              <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.6, color: '#D8DEE9' }}>
                <li>Lecturer(Contractual) @ ICE department @ Daffodil International University</li>
              </ul>
            </div>
            ...
            <div
              ...
              onClick={() => window.open('https://www.linkedin.com/in/mostafa-rifat-tazwar/', '_blank')}
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', gap: '10px' }}>
                <span style={{ fontSize: '1.5rem' }}>💼</span>
                <h3 style={{ margin: 0, color: '#A3BE8C', fontSize: '1.05rem' }}>Industry</h3>
              </div>
              <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.6, color: '#D8DEE9' }}>
                <li>AI/ML Intern @ <strong style={{ color: '#EBCB8B' }}>Open Refactory</strong></li>
                <li>Full Stack Developer @ <strong style={{ color: '#EBCB8B' }}>Foam On Latte</strong></li>
                <li>Ex-fellow @ <strong style={{ color: '#EBCB8B' }}>Headstarter AI</strong></li>
              </ul>
            </div>
            ...
            <div
              ...
              onClick={() => window.open('https://cse.buet.ac.bd', '_blank')}
            ...
            >
              ...
              <ul style={{ margin: 0, paddingLeft: '20px', lineHeight: 1.6, color: '#D8DEE9' }}>
                <li>B.Sc.Engg (with Honours) in CSE @ <strong style={{ color: '#D08770' }}>BUET</strong>, 2022 - 2026</li>
                <li>H.S.C @ <strong style={{ color: '#D08770' }}>Notre Dame College</strong>, 2018 - 2020</li>
                <li>S.S.C @ <strong style={{ color: '#D08770' }}>Cantonment English School &amp; College</strong>, 2016 - 2018</li>
              </ul>
            </div>
          </div>
        </div>
